...
export default function OpeningSpotlight() {
  ...
  return (
    <div className="fixed top-0 left-0  w-full h-screen">
      <div id="container" className="absolute w-full h-screen"></div>
      <img
      ...
      {/* text  */}
      <div className="absolute leading-none flex-col  bottom-[14%] left-[50%]  -translate-x-[50%] flex justify-center items-center">
